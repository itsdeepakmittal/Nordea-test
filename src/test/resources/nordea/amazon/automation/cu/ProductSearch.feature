Feature: 1. It should be possible to search for Nikon Items at http://www.amazon.com 
		 ...
		 3. Find the KeyWord Nikon D5 from the Product title of the second item 

Scenario: Find Nikon D5 from Nikon Product List
    ...
    Then Product title of Second item contains Nikon D5
